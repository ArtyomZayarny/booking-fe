    ...
    <header className="bg-[#013B94]">
      ...
      >
        ...
        <div className="flex lg:hidden">
          <button
            type="button"
            className="-m-2.4 inline-flex items-center justify-center rounded-md p-2.5 text-white"
        ...
        <Popover.Group className="hidden lg:flex lg:gap-x-12">
          <Popover className={"relative"}>
            <Popover.Button className="flex items-center gap-x-1 test-sm font-semibold leading-6 text-white">
              Stays
              ...
              <Popover.Panel className="absolute bg-white -left-8 top-full z-10 mt-3 w-screen max-w-md overflow-hidden rounded-3xl shadow-lg ring-1 ring-gray-900/5">
                <div className="p-4">
                  {products.map((item) => (
                    ...
                    >
                      <div
                        className="flex h-11 w-11 flex-none items-center justify-center rounded-lg bg-gray-50
